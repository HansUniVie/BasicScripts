function [] = runSO_TimeFrameOfInterest(setupFile, actuatorfile, modelFile, motionFile, grfFile, startTime, endTime, outputPath)
%runSO_TimeFrameOfInterest Summary of this function goes here
