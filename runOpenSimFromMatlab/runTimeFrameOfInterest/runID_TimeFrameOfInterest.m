function [] = runID_TimeFrameOfInterest(setupFile, modelFile, motionFile, grfFile, startTime, endTime, outputPath)
%runID_TimeFrameOfInterest Summary of this function goes here
