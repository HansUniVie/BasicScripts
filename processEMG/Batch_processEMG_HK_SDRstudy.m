...
sub_set={'SDR12_post','SDR14_pre','SDR14_post','SDR16_pre','SDR16_post','SDR26_pre','SDR26_post'} % ,'SDR05_post','SDR07_pre','SDR07_post'
for n=1:length(sub_set)
    ...
    dir_main = 'C:\Users\u0113767\Documents\WORK_KULeuven\SDR_project\SDR_proccessed\SDR\';
    ...
    dir_vicon_main = 'J:\GBW-0301_HumanMovementBiomechanics\SimCP\Patient Database\SimCP database\Retrospective Database\GANGLABO RAW DATABASE SIMCP CP\';
    dir_Jdrive = 'J:\GBW-0301_HumanMovementBiomechanics\SimCP\Model_Database\SDR\';
